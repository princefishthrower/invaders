    ...
    render() {
        ...
        return (
          <div className="container">
              ...
              <p>There are 2<sup>15</sup>-1 possible unique combinations of this configuration, or 32,768 - 1 = 32,767. We subtract 1 from 32,768, since the Invader with all 15 blocks unactived would be an empty 30 x 30 block. (Oppositely, an Invader with all 15 blocks activated is a solid 30 x 30 block.)</p>
